...
describe("Seniority Badge Upgrade", function () {
  ...
  describe("Upgrade data", () => {
    ...
    it("Can increase claimed list after upgrade without affecting next claimlist", async function () {
      let owner;
      let userAddr1;
      let userAddr2;
      let userAddr3;
    ...
    it("Can remove from whitelist after upgrade without affecting next whitelist", async function () {
      let owner;
      let userAddr1;
      let userAddr2;
      let userAddr3;
